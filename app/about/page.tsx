      ...
      <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
        ...
        <div className="space-y-6">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Chris Gray is a multi-faceted entrepreneur who has built a thriving
            ecosystem of businesses and communities. As co-owner of Red Palm
            Studios, he serves big brands and small businesses in the trades
            industry with forward-thinking marketing strategies.
          </p>

          <p className="text-muted-foreground leading-relaxed">
            An entrepreneur at heart, Chris turned personal passion into success
            with Bald Buck Seasoning and continues to innovate through the Bald
            Buck Newsletter. Most notably, he founded the EARN CORE COMMUNITY,
            bringing together over 4,000 entrepreneurs in a vibrant network of
          ...
          <Card className="hover:shadow-lg transition-shadow duration-300">
            ...
            <CardContent className="space-y-4">
              ...
              <p className="text-muted-foreground">
                ...
                value that your audience can implement immediately.
              </p>
            </CardContent>
          </Card>
        </div>
