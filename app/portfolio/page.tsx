...
export default function PortfolioPage() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "A weather application with forecasts, location-based data, and customizable alerts.",
    ...
    },
    {
      ...
      description: "A custom CMS built for a marketing agency to manage client websites and content.",
    ...
    },
    {
      ...
      description: "A social platform for sharing and discovering recipes with user profiles and collections.",
  ...
  return (
    <div className="container py-12 md:py-16">
      <div className="max-w-3xl mx-auto text-center space-y-3 mb-12">
        <h1 className="font-playfair text-4xl md:text-5xl font-bold tracking-tight">Portfolio</h1>
