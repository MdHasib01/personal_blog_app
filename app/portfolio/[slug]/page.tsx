    ...
    <article className="pb-16">
        ...
        <div className="bg-background border border-border/40 rounded-lg p-6 md:p-10 shadow-sm max-w-4xl mx-auto">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
            {project.galleryImages.map((img, index) => (
              <div key={index} className="rounded-lg overflow-hidden border border-border/40">
      ...
      <div className="container mt-16">
        <div className="max-w-4xl mx-auto">
          <h2 className="font-playfair text-2xl font-bold mb-6">Other Projects</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {sampleProjects
              .filter(p => p.id !== project.id)
              .slice(0, 3)
              .map(otherProject => (
                <Link key={otherProject.id} href={`/portfolio/${otherProject.id}`} className="group">
...
const sampleProjects = [
  {
    ...
    overview: "This project was developed to create a modern e-commerce experience with fast performance, SEO optimization, and a seamless checkout process.",
    ...
    challenges: "One of the main challenges was implementing a performant filtering system that could handle multiple filter criteria without sacrificing user experience. I solved this by implementing server-side filtering with efficient database queries and client-side caching.",
    results: "The platform achieved a 40% faster loading time compared to the client's previous solution, resulting in a 25% increase in conversion rate and improved SEO rankings.",
    demoUrl: "#",
    repoUrl: "#",
    galleryImages: [
  ...
  },
  {
    ...
    overview: "This task management application was designed to help teams collaborate effectively with real-time updates, task assignment, and progress tracking.",
    ...
    challenges: "Implementing the real-time synchronization while maintaining optimal performance was challenging. I utilized Firebase's real-time database with careful data structuring and selective subscription patterns to minimize unnecessary updates.",
    results: "The application was adopted by several small teams and has received positive feedback for its intuitive interface and reliable real-time functionality. It helped one client reduce their project management overhead by 30%.",
    demoUrl: "#",
    repoUrl: "#",
    galleryImages: [
  ...
  },
  {
    ...
    description: "A dashboard for tracking personal finances with data visualization and budgeting tools.",
    overview: "This personal finance application helps users track their income, expenses, and investments with intuitive visualizations and budgeting features.",
    ...
    challenges: "The main challenge was ensuring data privacy and security while providing seamless bank integration. I implemented robust encryption, secure API design, and followed financial industry best practices for data handling.",
    results: "Users reported better financial awareness and improved saving habits after using the dashboard for a few months. The visualization features were particularly praised for making financial data more accessible and actionable.",
    demoUrl: "#",
    repoUrl: "#",
    galleryImages: [
